...
void protobuf_AssignDesc_Global_2eproto() {
  ...
  static const int Global_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Global, your_doc_id_),
  };
  Global_reflection_ =
  ...
  static const int Field_ElementInfo_offsets_[6] = {
...
void protobuf_AddDesc_Global_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "al.Error\022\023\n\013your_doc_id\030\006 \002(\r\"\243\002\n\005Error\022"
    "\023\n\017NOTSETDIRECTION\020\001\022\022\n\016WRONGDIRECTION\020\002"
    "\022\r\n\tWRONGMOVE\020\003\022\031\n\025NOTSETFLUXCAPATITORID"
    "\020\004\022\033\n\027NOTSETFLUXCAPATITORTIME\020\005\022\030\n\024WRONG"
    "FLUXCAPATITORID\020\006\022\032\n\026WRONGFLUXCAPATITORT"
    "IME\020\007\022\024\n\020NOTSETCAPABILITY\020\010\022\023\n\017WRONGCAPA"
    "BILITY\020\t\022\026\n\022WRONGUSECAPABILITY\020\n\022\024\n\020COMM"
    "ANDCOLLOSION\020\013\022\033\n\027YOURDOCTRAVELLINGINTIM"
    "E\020\014\"\303\003\n\005Field\022,\n\007element\030\001 \001(\0132\033.protoco"
    "l.Field.ElementInfo\0226\n\021next_tick_arrives"
    "\030\002 \001(\0162\033.protocol.Field.ElementType\032\365\001\n\013"
    "ElementInfo\022)\n\004type\030\001 \002(\0162\033.protocol.Fie"
    "ld.ElementType\022\032\n\003doc\030\002 \001(\0132\r.protocol.D"
    ...
    "\003DOC\020\002\022\010\n\004WALL\020\004\022\t\n\005CHEST\020\005\022\014\n\010DELOREAN\020"
    "\006\022\016\n\nCAPABILITY\020\007", 937);
...
const Global_Error Global::COMMANDCOLLOSION;
const Global_Error Global::YOURDOCTRAVELLINGINTIME;
...
const int Global::kYourDocIdFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_your_doc_id;
        break;
      }
...
void Global::SerializeWithCachedSizes(
  ...
  // required uint32 your_doc_id = 6;
  if (has_your_doc_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(6, this->your_doc_id(), output);
  }
...
::google::protobuf::uint8* Global::SerializeWithCachedSizesToArray(
  ...
  // required uint32 your_doc_id = 6;
  if (has_your_doc_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(6, this->your_doc_id(), target);
  }
...
void Global::MergeFrom(const Global& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_your_doc_id()) {
      set_your_doc_id(from.your_doc_id());
    }
  }
...
void Global::Swap(Global* other) {
  if (other != this) {
    ...
    std::swap(your_doc_id_, other->your_doc_id_);
