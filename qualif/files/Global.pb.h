...
const Global_Error Global_Error_Error_MAX = Global_Error_WRONGUSECAPABILITY;
...
class Field_ElementInfo : public ::google::protobuf::Message {
 public:
  ...
  inline const ::protocol::Enemy& enemy() const;
  inline ::protocol::Enemy* mutable_enemy();
  inline ::protocol::Enemy* release_enemy();
  inline void set_allocated_enemy(::protocol::Enemy* enemy);
...
class Field : public ::google::protobuf::Message {
 public:
  ...
  static const ElementType ENEMY = Field_ElementType_ENEMY;
...
// optional .protocol.Enemy enemy = 3;
inline bool Field_ElementInfo::has_enemy() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Field_ElementInfo::set_has_enemy() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Field_ElementInfo::clear_has_enemy() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Field_ElementInfo::clear_enemy() {
  if (enemy_ != NULL) enemy_->::protocol::Enemy::Clear();
  clear_has_enemy();
}
inline const ::protocol::Enemy& Field_ElementInfo::enemy() const {
  // @@protoc_insertion_point(field_get:protocol.Field.ElementInfo.enemy)
  return enemy_ != NULL ? *enemy_ : *default_instance_->enemy_;
}
inline ::protocol::Enemy* Field_ElementInfo::mutable_enemy() {
  set_has_enemy();
  if (enemy_ == NULL) enemy_ = new ::protocol::Enemy;
  // @@protoc_insertion_point(field_mutable:protocol.Field.ElementInfo.enemy)
  return enemy_;
}
inline ::protocol::Enemy* Field_ElementInfo::release_enemy() {
  clear_has_enemy();
  ::protocol::Enemy* temp = enemy_;
  enemy_ = NULL;
  return temp;
}
inline void Field_ElementInfo::set_allocated_enemy(::protocol::Enemy* enemy) {
  delete enemy_;
  enemy_ = enemy;
  if (enemy) {
    set_has_enemy();
  ...
  // @@protoc_insertion_point(field_set_allocated:protocol.Field.ElementInfo.enemy)
}
